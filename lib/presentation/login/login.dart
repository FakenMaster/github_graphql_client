...
class GithubLoginWidget extends StatefulWidget {
  ...
  final String githubClentSecret;
...
class _GithubLoginWidgetState extends State<GithubLoginWidget> {
  ...
  Future<oauth2.Client> _getOAuth2Client(Uri redirectUrl) async {
    if (widget.githubClientId.isEmpty || widget.githubClentSecret.isEmpty) {
    ...
    var grant = oauth2.AuthorizationCodeGrant(
      ...
      _tokenEndpoint,
      secret: widget.githubClentSecret,
  ...
  Future<Map<String, String>> _listen() async {
    ...
    print('重定向url参数:${json.encode(params)}');
    return params;
  }
}
